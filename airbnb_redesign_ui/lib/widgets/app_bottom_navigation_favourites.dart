...
class AppBottomNavigationProfileFavorites extends StatefulWidget {
  @override
  _AppBottomNavigationProfileFavoritesState createState() => _AppBottomNavigationProfileFavoritesState();
}

class _AppBottomNavigationProfileFavoritesState extends State<AppBottomNavigationProfileFavorites> {
  String activePage = "favorites"; // Track active page
