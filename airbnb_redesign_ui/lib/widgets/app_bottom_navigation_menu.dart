...
class AppBottomNavigationProfileMenu extends StatefulWidget {
  @override
  _AppBottomNavigationProfileMenuState createState() => _AppBottomNavigationProfileMenuState();
}

class _AppBottomNavigationProfileMenuState extends State<AppBottomNavigationProfileMenu> {
  String activePage = "menu"; // Track active page
